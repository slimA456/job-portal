...
const Application = () => {
  ...
  return (
    <>
      <Navbar />
      <div className='container px-4 min-h-[65vh] 2xl:px-20 mx-auto my-100 my-100'>
        ...
        <div className='flex gap-2 mb-6 mt-3'>
          {
            isEdit
              ? <>
                ...
                <button className=' bg-green-100 border rounded-lg px-4 py-2' onClick={e => setIsEdit(false)}>Save</button>
              </>
          ...
          <tbody>
            {jobsApplied.map((job, index) => true ? (
              <tr>
                ...
                <td className='py-3 px-4 border-b'>{moment(job.date).format('ll')}</td>
                <td className='py-3 px-4 border-b'>
